...
namespace JobsOffer.Api.Server.Controllers
{
    ...
    {
        public WebSiteController(IGenericService<WebSite> genericService, IMapper mapper, ILogger<GenericController<WebSite, WebSiteViewModel>> logger, IHostEnvironment hostEnvironment) : base(genericService, mapper, logger, hostEnvironment)
        {
        }
    }
}
